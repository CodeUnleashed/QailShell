# QailShell
This is my personal shell setup. You can use this to setup your shell in a similar way. Currently this script is tailored to installing these dependencies on Mac, but I will add Linux support soon.
